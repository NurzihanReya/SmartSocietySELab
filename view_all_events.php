...
<body>
  ...
  top: 30px; background-color:#7c7583;height:8000px;">
    ...
    ?>
                        ...
                        <div class="shadow-1-strong bg-white my-5 p-5" id="education">
                            <div class="education-section"
                                style="position: relative;top: 30px; background-color:#fff;height:5900px;">
   ...
   position: relative;left:7px; ">
                                        <div class="myimg"><img src="./event_images/<?php echo $event['image']; ?>"
                                                style="object-fit: cover; width:800px;height: 250px;border-radius: 10px;
    ...
    padding: 3px;position:relative;left:60px;top:20px"></div>
                                        ...
                                        <div class="textdetail" style="position:relative;left:50px;top:40px"><a
                                                href="view_specific_event.php?e_id=<?php echo $event['e_id'] ?>"><?php echo ("Click to View Details") ?></a>
                                        </div>
