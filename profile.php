            ...
            <div class="resume-container">
                <div class="shadow-1-strong bg-white my-5" id="intro">
                    <div class="b-info text-white">
                        <div class="cover b-image" style="position: relative;top: -1px;"><img src="images/head3.png"
                                style="height:480px;width:1115px;">
                            <div class="mask"
                                style="background-color: rgba(187, 147, 147, 0.164);backdrop-filter: blur(2px);">
                                <div class="text-center p-5">
                                    <?php
                  if ($type=="user") {
                  ?>
                                    <div class="avatar p-1"><img class="img-thumbnail shadow-2-strong"
                                            src="images/student.jpg" width="160" height="160" /></div>
                                    <?php
                  } else {
                  ?>
                                    <div class="avatar p-1"><img class="img-thumbnail shadow-2-strong"
                                            src="images/verifier.jpg" width="160" height="160" /></div>
                                    <?php
                  }
                  ?>
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="pb-2 fw-bolder"><i class="far fa-calendar-alt pe-2 text-muted"
                                                    style="width:24px;opacity:0.85;"></i>Name</div>
                                        </div>
                                        <div class="col-sm-7">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="pb-2 fw-bolder"><i class="far fa-envelope pe-2 text-muted"
                                                    style="width:24px;opacity:0.85;"></i> ID</div>
                                        </div>
                                        <div class="col-sm-7">
