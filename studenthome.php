          ...
          <div class="col-md-4">
            <div class="team-member">
              ...
              <div class="down-content">
                <a href="servicemiddleman.php?b_id=<?php echo $block['b_id']; $_SESSION['reportblock']=$block['b_id'];?>"><?php echo htmlspecialchars($block['b_id']) ?></a>
                <form action="reportmiddleman.php" method="POST">
                <!-- <div class="input-group" style="float: right; margin-bottom:2px;"> -->
                    <button name="sosreport" value="firereport">Fire</button>
                    <button name="sosreport" value="crimereport">Crime</button>
                    <button name="sosreport" value="accidentreport">Accident</button>
