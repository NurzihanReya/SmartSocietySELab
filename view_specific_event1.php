    ...
    <div class="carousel-inner ">
      ...
      <div class="inputfield">
       ...
       <div class="inputfield">
          ...
          <input type="text" class="input" name="orgdiseases" placeholder="e.g. COVID-19, Dengue, etc">
       </div>
       <div class="inputfield">
          <label>Current Symptoms: </label>
          <input type="text" class="input" name="orgsymptoms" placeholder="e.g. Fever, Rashes, etc">
       </div>
       <div class="inputfield">
          <label>Current Medication: </label>
          <input type="text" class="input" name="orgmedication" placeholder="e.g. Napa, NapaExtra, etc">
       </div>
       <div class="inputfield">
       ...
       <div class="inputfield">
          ...
          <input type="datetime-local" class="input" name="orgdatetime">
       </div>
