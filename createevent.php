...
<body>
    ...
    <nav class="navbar navbar-expand-xl" style="position:relative; left:40px ;width:1350px;Background-color:#cf8c10;">
        <a href="#" class="navbar-brand" style="position:relative; left:10px "><i
                class="fa fa-cube"></i>Smart<b>Society</b></a>
    ...
    <div>
        ...
        <form action="" class="form-input" method="post" enctype="multipart/form-data">
           ...
           -->
                        <select class="form-select" name="typeorg" aria-label="Default select example"
