    ...
    <div class="carousel-inner ">
      ...
      <div class="inputfield">
       ...
       <div class="inputfield">
          ...
          <input type="datetime-local" class="input" name="orgdfiretime">
       </div>
       <div class="inputfield">
          <label>Place of Occurrence: </label>
          <input type="datetime-local" class="input" name="orgfireplace">
       </div>
       <div class="inputfield">
          <label>Estimated area of fire: </label>
          <input type="text" class="input" name="orgfirearea" placeholder="e.g. 2000 sq. ft., two buildings, etc">
       </div>
       <div class="inputfield">
          <label>Other Rescue-Related Description: </label>
          <textarea type="text" rows="20" cols="50" class="input" name="orgrescuedescription"></textarea>
          <!-- <input type="datetime-local" class="input" name="orgtime"> -->
       </div>
       <div class="inputfield">
